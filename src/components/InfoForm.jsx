...
const InfoForm = () => {
    ...
    return (
        <div id="info-form" className="absolute justify-center items-center h-screen top-0 left-0 px-2 bg-[#000000e1] hidden w-full">
            <form action={handleSubmit} className=" bg-[#696969] rounded-2xl border-1 border-[#01578F] flex flex-col gap-2 items-center justify-center py-3 px-5 text-sm md:text-base">
