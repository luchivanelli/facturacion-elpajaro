...
const DeleteModal = ({itemId})=> {
    ...
    return (
        <div id="delete-item" className="absolute hidden justify-center items-center h-screen left-0 top-0 bg-[#000000e1] w-full">
            <div className="mx-3 my-6 bg-[#b6b6b669] card rounded-2xl border-1 border-[#01578F] flex flex-col gap-2 items-center justify-center py-3 px-5 text-sm md:text-base">
